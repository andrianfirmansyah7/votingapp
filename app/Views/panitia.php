        ...
        <!-- Main row -->
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Panitia Pemilihan</h3>
              </div>
              <div class="row">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
                  <label for="lengkap">Username</label>
                  <input type="text" class="form-control" id="lengkap" name="username" placeholder="Nama" required>
                </div>
                  <div class="form-group">
                  ...
                  <select class="form-control" name="role" required>
                    ...
                    <option value="Pemeriksa DPT">Pemeriksa DPT</option>
                    <option value="Validator">Validator</option>
                    <option value="Tim Sukses">Tim Sukses</option>
                  </select>
                  </div>
                  <div class="form-group">
                  <label for="lengkap">Password</label>
                  <input type="password" class="form-control" id="lengkap" name="password" placeholder="Password" required>
                  </div>              
        ...
        <input type="submit" class="btn btn-primary">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php 
                  $a = 1;
                  foreach($panitia as $as){?>
                  <tr>
                    <td><?php echo $a;?></td>
                    <td><?php echo $as->user_id;?></td>
                    <td><?php echo $as->user_name;?></td>
                    <td><?php echo $as->user_email;?></td>
                    <td>
                    <div class="btn-group">
                    ...
                    <a href="<?php echo base_url()?>/Admin/deletePanitia/<?php echo $as->user_id?>" class="btn btn-danger" title="Hapus"><i class="fa fa-trash"></i></a>
                  </div>
                  </td>
                  </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url()?>/Admin/updatePanitia" method="POST">
                  <input type="hidden" class="form-control" id="lengkap" name="id" placeholder="NIM" maxlength="10" value="<?php echo $as->user_id;?>">

                  <div class="form-group">
                  <label for="lengkap">Nama Lengkap</label>
                  <input type="text" class="form-control" id="lengkap" name="nama" placeholder="Nama Lengkap" value="<?php echo $as->user_name;?>" required>
                  </div>
                  <div class="form-group">
                  <label for="lengkap">Email</label>
                  <input type="email" class="form-control" name="email" value="<?php echo $as->user_email;?>" id="lengkap" name="email" placeholder="Email" required>
                  </div>
                  <div class="form-group">
                  <label for="lengkap">Password</label>
                  <input type="password" class="form-control" id="lengkap" name="password" placeholder="Password" required>
