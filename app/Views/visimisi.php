...
<section>
	<h1 style="font-size: 30px">Visi Misi Calon KM dan Wakil KM</h1>
	<div class="container">
    <?php foreach($calon as $row):?>
    <div class="row" style="margin-bottom: 30px;">
    	<div class="col-sm-4">
    	<img src="/foto/<?= $row->foto_calon_km;?>" style="width: 150px;height: 200px;margin-top: 20px;">
    	<img src="/foto/<?= $row->foto_calon_wakil;?>" style="width: 150px;height: 200px;margin-top: 20px;">
    	</div>
    	<div class="col-sm">
    	<h3><?= $row->nomor_urut ?></h3>
    	<b><?= $row->nama_calon_km?> - <?=$row->nama_calon_wakil?></b><br><br>
    	<b>Visi</b><br>
    	<?= $row->visi;?><br><br>
    	<b>Misi</b>
    	<?= $row->misi;?>
