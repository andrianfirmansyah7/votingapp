...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="<?php echo base_url();?>/Login">Login</a>
			</li>
		</ul>
	</div>

	<div class="heroe">
		<h1>PEMILIHAN KETUA MURID (KM) SI-43-05 2021</h1>
		<h2>Mari Bersama Membawa Kelas SI-43-05 Menjadi Lebih Baik</h2>
	</div>

</header>

<section>
	<h1>Mari Memilih #2021LebihBaik</h1>
	<p>Sudah Siap dan Memahami Visi-Misi dari Calon?</p>
	<a href="<?php echo base_url();?>/Awal/memilih" class="btn btn-info">Yuk Memilih</a>
	<br>
</section>
...
<div class="further">
	<section>
		...
		<p>Dengan anda ikut memilih pemimpin Kelas SI-43-05 2021 - 2022, anda telah mendukung kemajuan serta perkembangan kelas menuju yang lebih baik</p>
		...
		<p>Mari kita sama-sama terbuka untuk saling berdiskusi dan berbincang mengenai permasalahan yang ada di kelas serta memecahkannya agar dapat ditemukan solusinya !</p>
		<h2>
		...
		<p>Jika anda ingin, mari berkontribusi bersama dalam pengembangan aplikasi ini agar menjadi aplikasi yang baik</p>
