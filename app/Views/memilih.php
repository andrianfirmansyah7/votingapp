...
<section>
	<h1 style="font-size: 30px">#SI4305Memilih</h1>
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
			<form method="POST" action="<?php echo base_url()?>/Awal/token">
				  <div class="form-group">
                  <label for="lengkap">Masukkan NIM</label>
                  <input type="text" class="form-control" id="lengkap" name="nim" placeholder="Masukkan NIM" required>
                  </div>
				  <div class="form-group">
                  <label for="lengkap">Masukkan Token</label>
                  <input type="text" class="form-control" id="lengkap" name="token" placeholder="Masukkan Token" required>
                  </div>
			</div>
		</div>
			<input type="submit" value="Cari Token" class="btn btn-primary">
			</form>
